...
<body class="relative min-h-screen flex items-center justify-center font-sans bg-slate-50 lg:bg-transparent overflow-y-auto lg:overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 flex flex-col lg:flex-row items-center justify-between gap-12 pt-28 pb-10 lg:pt-0 lg:pb-0">
        ...
        <div class="hidden lg:block w-full lg:w-1/2 text-white pb-10 lg:pb-0">
            ...
            <div class="flex flex-col gap-4">
                <div class="flex items-center gap-4 text-sm font-bold bg-white/10 px-5 py-3.5 rounded-2xl border border-white/20 backdrop-blur-md shadow-lg w-max hover:scale-105 transition-transform duration-300">
                    <div class="w-8 h-8 rounded-xl bg-white/20 flex items-center justify-center shrink-0 shadow-sm border border-white/30 text-xs font-black">1</div>
                    Buat akun dalam 1 menit
                </div>
                <div class="flex items-center gap-4 text-sm font-bold bg-white/10 px-5 py-3.5 rounded-2xl border border-white/20 backdrop-blur-md shadow-lg w-max lg:ml-6 hover:scale-105 transition-transform duration-300">
                    <div class="w-8 h-8 rounded-xl bg-white/20 flex items-center justify-center shrink-0 shadow-sm border border-white/30 text-xs font-black">2</div>
                    Pilih jadwal & booking
                </div>
                <div class="flex items-center gap-4 text-sm font-bold bg-white/10 px-5 py-3.5 rounded-2xl border border-white/20 backdrop-blur-md shadow-lg w-max lg:ml-12 hover:scale-105 transition-transform duration-300">
                    <div class="w-8 h-8 rounded-xl bg-white/20 flex items-center justify-center shrink-0 shadow-sm border border-white/30 text-xs font-black">3</div>
        ...
        <div class="w-full lg:w-5/12 max-w-md mx-auto lg:mx-0 flex justify-center lg:justify-end">
            <div class="w-full bg-white lg:bg-white/95 backdrop-blur-xl rounded-3xl shadow-xl lg:shadow-2xl border border-slate-200 lg:border-slate-100 p-8 sm:p-10 transition-shadow duration-300 hover:shadow-blue-500/10">
                ...
                @if ($errors->any())
                    <div class="bg-rose-50 border border-rose-100 text-rose-600 p-4 rounded-xl mb-6 flex items-start gap-3 text-sm animate-shake">
                ...
                <form action="{{ route('register.submit') }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 group-focus-within:text-[#0061ff] transition-colors">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-[#0061ff] transition-colors">
                    ...
                    <button type="submit" class="w-full bg-gradient-to-r from-[#0061ff] to-[#00c6ff] hover:from-[#0055e6] hover:to-[#00b2e6] text-white font-black py-4 rounded-xl flex justify-center items-center gap-2 mt-6 text-[15px] tracking-wide transition-all transform hover:-translate-y-0.5 shadow-lg hover:shadow-blue-500/50 shadow-blue-500/30">
                        DAFTAR SEKARANG
